      ...
      <div className="content-block card p-4" style={{ backgroundColor: 'var(--bg-secondary)', borderRadius: 'var(--radius-lg)' }}>
        <section style={{ marginBottom: '2rem' }}>
          ...
          <p className="text-secondary" style={{ lineHeight: 1.6 }}>
            By accessing and using Metron, you accept and agree to be bound by the terms and
        ...
        <section>
          ...
          <p className="text-secondary" style={{ lineHeight: 1.6 }}>
            When you post reviews or comments on universities and programs, you grant Metron a non-exclusive,
